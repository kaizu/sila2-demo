...
class Server(SilaServer):
    def __init__(
        ...
        if description is None:
            description = "Mock SiLA2 server for Automated Plate Seal Remover"
        server_type = env_type if env_type else "AutomatedPlateSealRemoverServer"
        super().__init__(
            server_name=name,
        ...
        self.automatedplatesealremovercontroller = AutomatedPlateSealRemoverControllerImpl(self)
    ...
    def require_item_at_location(self, *, command_name: str) -> None:
        ...
        Called by commands that physically act on a plate (e.g. Peel)."""
